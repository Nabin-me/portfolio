...
import { IconCircle, IconCircleFilled, IconDotsDiagonal, IconGrain,} from "@tabler/icons-react";
...
function NavBar() {
  ...
  return (
    <header className="flex justify-between">
      <Logo />
      <nav className="h-[68px] bg-gradient-to-b from-white to-custom-gray rounded-xl shadow border border-background  backdrop-blur-2xl flex items-center justify-center text-sm">
